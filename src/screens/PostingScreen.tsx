...
interface Props {
  visible: boolean;
  onClose: () => void;
  /** Temporary: pass current user id until auth is wired up */
            ...
            <View style={styles.card}>
              ...
              >
                ...
                <View
                  style={[
                    ...
                    reqPortfolio && styles.requirementCircleActive,
                  ]}
                />
              </TouchableOpacity>
              ...
              >
                ...
                <View
                  style={[
                    styles.requirementCircle,
                    reqCoverLetter && styles.requirementCircleActive,
                  ]}
                />
              </TouchableOpacity>
            </View>
